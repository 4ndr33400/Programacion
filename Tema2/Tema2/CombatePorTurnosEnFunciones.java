...
public class CombatePorTurnosEnFunciones {
    ...
    public static void CharactersMenu() {
        ...
        System.out.println("Introduce cualquier letra para ver el siguiente personaje");
        next = shi.next().charAt(0);
    ...
    public static void main(String[] args) {
        ...
        int damagePlayer1 = random.nextInt(100);
        int damagePlayer2 = random.nextInt(100);
        ...
        while (HealthPlayer2 > 0 && HealthPlayer1 > 0) {
            ...
            if (HealthPlayer1 > 0 && HealthPlayer2 > 0) {
                if (DecisionRound == 1) {
                    ...
                    HealthPlayer2 = DamagePlayers(HealthPlayer2, HitPlayer1);
                    HealthPlayer2 = MinimumHealthPlayers(HealthPlayer2);
                    ...
                    HealthPlayer1 = HealingPlayer(HealthPlayer1, HealingPlayer1);
                    HealthPlayer1 = MaximumHealthPlayers(HealthPlayer1, ReHealthPlayer1);
                    System.out.println("El jugador 1 va en busca de una pocion         //Introduce cualquier letra para continuar//");
                    next = shi.next().charAt(0);
                    System.out.println("El jugador 1 ha encontrado una pocion de " + HealPlayer1 + " puntos de vida, por lo que su salud aumenta a " + HealthPlayer1 + "           //Introduce cualquier letra para continuar// ");
                    next = shi.next().charAt(0);
                }
            }
            if (HealthPlayer1 > 0 && HealthPlayer2 > 0) {
                ...
                if (DecisionRound == 1) {
                    ...
                    HealthPlayer1 = DamagePlayers(HealthPlayer1, HitPlayer2);
                    HealthPlayer1 = MinimumHealthPlayers(HealthPlayer1);
                    System.out.println("Al jugador 1 le quedan " + HealthPlayer1 + " puntos de vida                 //Introduce cualquier letra para continuar//");
                    next = shi.next().charAt(0);

                } else if (DecisionRound == 2) {
                    HealthPlayer2 = HealingPlayer(HealthPlayer2, HealingPlayer2);
                    HealthPlayer2 = MaximumHealthPlayers(HealthPlayer2, ReHealthPlayer2);
                    System.out.println("El jugador 2 va en busca de una pocion         //Introduce cualquier letra para continuar//");
                    next = shi.next().charAt(0);
                    System.out.println("El jugador 2 ha encontrado una pocion de " + HealPlayer2 + " puntos de vida, por lo que su salud aumenta a " + HealthPlayer2 + "          //Introduce cualquier letra para continuar//");
                    next = shi.next().charAt(0);
                }
            }
